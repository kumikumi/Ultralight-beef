...
namespace Ultralight.CAPI
{
	static
	{
		...
		*/
		...
		[CLink]
		public static extern JSValueRef JSEvaluateScript(JSContextRef ctx, JSStringRef script, JSObjectRef thisObject, JSStringRef sourceURL, int32 startingLineNumber, JSValueRef* exception);
		...
		*/
		...
		[CLink]
		public static extern bool JSCheckScriptSyntax(JSContextRef ctx, JSStringRef script, JSStringRef sourceURL, int32 startingLineNumber, JSValueRef* exception);
